...
class _SelectPetStatusReportContentState
  ...
  Widget build(BuildContext context) { 
    ...
    // Preferences.preferences(path: './utils/prefs').then((prefs) { setState(() => cryptoPrefs = prefs); }); // cryptoPrefs
    return Container(
  ...
  void reportStatus() async {
    ...
    // final cryptoPrefs = await Preferences.preferences(path: './utils/prefs');
    // final breathingValue= cryptoPrefs.get('breathing_key') ?? 0;
    // final heartrateValue = cryptoPrefs.getInt("heartrate_key") ?? 0;
    breathingFrequency = breathingValue;
    heartRate = heartrateValue;
